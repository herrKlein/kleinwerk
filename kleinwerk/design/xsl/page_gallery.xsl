...
<div id="main">
						<div class="inner">
              <ul>
                <xsl:apply-templates select="page/subpages/*|text()" />
              </ul>
              <xsl:apply-templates select="page/content[1]/*|text()"/>
              <xsl:apply-templates select="page/functionality/galleryimages/*|text()"/>
              <!--<xsl:apply-templates select="page/functionality/gallerynextprev/*|text()"/>-->             
             <xsl:apply-templates select="page/content[2]/*|text()"/>
             <xsl:apply-templates select="page/functionality/galleryimage/*|text()"/>
           </div>
         </div>
